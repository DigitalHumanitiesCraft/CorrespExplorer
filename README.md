...
3. Explore the correspondence through 12 different views
...
- 12 visualization views (map, timeline, network, chronicle, activity, comparison, etc.)
...
| [user-stories.md](docs/knowledge/user-stories.md) | 37 implemented features with acceptance criteria |
| [design.md](docs/knowledge/design.md) | UI/UX specifications, design system |
| [JOURNAL.md](docs/knowledge/JOURNAL.md) | Development history (46 phases) |
